...
def main(cfg):
    ...
    TARGET_RUN = cfg.pipeline.eval_on_gt.src_existing
    cfg.pipeline.results_root_src = cfg.pipeline.eval_on_gt.results_root_src
    cfg.pipeline.preload.do_continue_from_existing = False
    cfg.pipeline.result_src_name_suffixe = cfg.pipeline.eval_on_gt.result_src_name_suffixe
    ...
    # load data
    DATA_SRC = os.path.join(ROOT_SRC, cfg.pipeline.eval_on_gt.src_data_gt)
